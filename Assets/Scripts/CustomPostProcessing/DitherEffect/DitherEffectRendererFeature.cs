...
public class DitherEffectRendererFeature : ScriptableRendererFeature
{
    ...
    class DitherEffectRendererFeaturePass : ScriptableRenderPass
    {
        ...
        private const string m_PassName = "DitherEffectPass"; // Pass name is useful when debugging
        private Material m_BlitMaterial; // Contain the shader you apply to the current state of the rendered image
        ...
        // Setup the material for custom dither effect
        ...
        // PassData defines the data used when declaring the pass - the data that the rendering code can access
        // BUT we don't need any additional data for this pass in Dither Effect: can leave this empty or delete
